...
function MailService(sender, code) {
  ...
  const transporter = nodemailer.createTransport(`smtps://${sender}:${code}@smtp.qq.com`);
  return {
...
const sender = '2369969039';
const code = 'ngyoikiaeegndjhj';
const recipient = '835380624@qq.com';
const verCode = '123456';
const mailService = MailService(sender, code);
