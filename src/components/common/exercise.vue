      ...
      <div class="main-content">
        <div id="elements">
          <div>
            ...
            <el-button class="element-button" @click="updateEdges(item)" v-for="item in unduplicated_edges">画边 {{item}}
            </el-button>
          </div>
          <div>
  ...
  export default {
    ...
    methods: {
      showPopBox() {
        ...
        // 初始化
        this.nodes.push({ id: -1, label: "", x: 0, y: 0 });
        this.nodes.push({ id: 0, label: "0", x: 50, y: 0 });
